...
PHASE_SPACE_OUTPUT_ROOT = Path("Output_local") / "PhaseSpaceScan"
OUTPUT_ROOT = Path("Output_local") / "PhaseSpaceConfigScan"
LOG_PATH = Path("Output_local") / "PhaseSpaceConfigScan.log"
